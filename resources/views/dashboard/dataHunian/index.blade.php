        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th class="text-center" scope="col">Kamar Mandi</th>
                    <th class="text-center" scope="col">Kamar Tidur</th>
            ...
            <tbody>
                @foreach ($hunians as $h)
                    <tr>
                        ...
                        <td class="text-center"><img src={{ asset('storage/' . $h->gambar) }} class="rounded-circle"
                                style="width:40px;height:40px;" /></td>
                        <td class="text-center">{{ $h->nama }}</td>
                        <td class="text-center">{{ $h->lokasi }}</td>
                        <td class="text-center">{{ $h->harga }}</td>
                        <td class="text-center">{{ $h->jumlah_kamar_tidur }}</td>
                        <td class="text-center">{{ $h->jumlah_kamar_mandi }}</td>
